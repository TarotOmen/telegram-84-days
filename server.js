...
async function forwardTributeToTarot(
  ...
  console.log(
    "Tribute event forwarded to Tarot"
  );
}
...
async function configureTelegramBot() {
  ...
  if (!BOT_TOKEN) {
    ...
    console.log(
      "BOT_TOKEN is missing, Telegram bot configuration skipped."
    );
  ...
  try {
    ...
    console.log(
      `Telegram webhook configured: ${API_PUBLIC_URL}/telegram/webhook`
    );
  ...
  async (
    ...
    try {
      ...
      if (!pool) {
        ...
        console.error(
          "SESSION ERROR: PostgreSQL pool is not configured"
        );
  ...
  async (
    ...
    try {
      ...
      if (!pool) {
        ...
        console.error(
          "STATE SAVE ERROR: PostgreSQL pool is not configured"
        );
      ...
      if (!verified) {
        ...
        console.error(
          "STATE SAVE ERROR: database verification failed",
          JSON.stringify({
            telegram_id:
              telegramUser.id
          })
