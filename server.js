...
async function handleTelegramUpdate(update) {
  ...
  if (
    ...
    await telegramApi("sendMessage", {
      ...
      text:
        "84 ДНЯ — твой 12-недельный цикл.\n\n" +
        "Одна цель. 84 дня. Каждый день — действие по своей цели.",
...
app.post(
  ...
  async (req, res) => {
    ...
    // Telegram ждёт быстрый ответ 200
    res.sendStatus(200);
...
app.post(
  ...
  async (req, res) => {
    ...
    res.json({
      ...
      error:
        "Tribute payment is not connected yet"
...
app.post(
  ...
  async (req, res) => {
    ...
    res.json({
      ...
      error:
        "Telegram Stars payment is not connected yet"
